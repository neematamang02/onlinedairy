...
<?php include 'header.php';?>
    <nav>
        <ul>
            ...
            <li><a href="myorders.php">customer order</a></li>
        ...
        <tr>
         <form action="" method="post">
                        ...
                        <td>
                            ...
                            <input type="hidden" name="update_qty" value="<?php echo $fetch_cart['id']; ?>">
                            <input type="hidden" name="subtotal" value="<?= $fetch_cart['subtotal']; ?>">
                            <input type="number" name="qty" class="quantity" value="<?= $fetch_cart['quantity']; ?>">
                            <input type="submit" value="Update"
                                onclick="return confirm('do u want to update your cart?')" name="update_qty">
