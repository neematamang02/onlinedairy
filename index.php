...
<body>
    ...
    <div class="offer-deals">
        ...
        <p>Hurry up!</p>
        <a href="productdetail.php"><button class="deal-btn">Order now</button></a>

        </div>
    </div>

    <div class="dairy-items" style="padding: 20px;">
        ...
        <div class="dairy-product-list-1">
            ...
            ?>
                <div class="dairy-products">
                    <a href="productdetail.php"><img src="vendor/uploadimage/<?php echo $fetch_products['product_image'] ?>" alt="image"></a>
                    <div class="details">
