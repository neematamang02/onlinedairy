            ...
            <div class="addproduct-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="username">
                        <br>
                        <h4>Product Name</h4>
                        <input type="text" name="productname" placeholder="Enter product name" required class="input-box" value="<?php echo $fetch_products['product_name']; ?>">
                    </div>
                    <div class="username">
                        <br>
                        <h4>Product Price</h4>
                        <input type="text" name="productprice" placeholder="Enter product price" required class="input-box" value="<?php echo $fetch_products['product_price']; ?>">
                    </div>
                    <div class="username">
                        <br>
                    ...
                    <div class="username">
                        ...
                        <textarea type="text" name="productdescription" placeholder="Enter product description" required class="input-box"><?php echo $fetch_products['product_description']; ?></textarea>
                    </div>
