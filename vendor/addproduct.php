        ...
        <div class="addproduct-form">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="username">
                    ...
                    <input type="number" name="qty" class="input-box" placeholder="Enter quantity">

                </div>
                <div class="username">
                    <br>
                    <h4>Product Image</h4>
                    <input type="file" name="uploadfile" accept="image/jpg, image/jpeg, image/png, image/webp"
                        placeholder="Enter product image" required class="input-box">
                </div>
                ...
                <div class="username">
                    ...
                    <textarea type="text" name="productdescription" placeholder="Enter product description" required
