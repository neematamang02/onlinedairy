...
if(isset($_POST['order'])){
    ...
    if(mysqli_num_rows($check_res)>0){
       $insert_order = "INSERT INTO `billing_details`(user_id, f_name, l_name, number, email, address, total_price) VALUES('$user_id', '$fname', '$lname', '$number', '$email', '$address', '$total_price')";
            ...
            <div class="billing-details">
                ...
                <form action="" method="post">
                    <div class="fullname">
                        <div class="firstn">
                            <h4>First Name</h4>
                            <input type="text" class="textbox" name="fname" required>
                        </div>
                        <div class="lastn">
                            <h4>Last Name</h4>
                            <input type="text" class="textbox" name="lname" required>
                        </div>
                    </div>
                    <div class="userid">
                        <h4>Phone number</h4>
            ...
            <div class="customerorder">
                ...
                <table>
                    ...
                    ?>
                                ...
                                ?>
                                    <span>(<?= '$'.$fetch_cart['price'].'/- x '. $fetch_cart['quantity']; ?> = $<?= $discounted_total ?>/-)</span>
                                </p>
